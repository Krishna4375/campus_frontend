...
export function MainAdminDashboard({ user, onLogout }: MainAdminDashboardProps) {
  ...
  const fetchPrAdmins = useCallback(async () => {
    setIsLoading(true);
    try {
      const response = await fetch('https://backend-1-8tb9.onrender.com/api/admin/pr-admins');
  ...
  const fetchPendingUsers = useCallback(async () => {
    setIsLoading(true);
    try {
      const response = await fetch('https://backend-1-8tb9.onrender.com/api/admin/pending-students');
  ...
  const fetchAllUsers = useCallback(async () => {
    setIsLoading(true);
    try {
      const response = await fetch('https://backend-1-8tb9.onrender.com/api/admin/all-students');
  ...
  const handleApproveUser = async (id: number) => {
    ...
    try {
      const response = await fetch(`https://backend-1-8tb9.onrender.com/api/admin/students/${id}/approve`, { method: 'POST' });
  ...
  const handleRejectUser = async (id: number) => {
    ...
    if (!userToProcess) return;
    try {
      const response = await fetch(`https://backend-1-8tb9.onrender.com/api/admin/students/${id}/reject`, { method: 'POST' });
  ...
  const handleDeletePRAdmin = async (id: number) => {
    ...
    try {
      const response = await fetch(`https://backend-1-8tb9.onrender.com/api/admin/pr-admins/${id}`, {
        method: 'DELETE',
      });
